...
pub fn install() {
    ...
    .game_acmd("game_specialnshoot", lucario_neutralb_shoot_smash_script)
    .game_acmd("game_specialairnshoot", lucario_neutralb_shoot_smash_script)
