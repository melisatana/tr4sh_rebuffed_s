...
pub fn install() {
    ...
    .game_acmd("game_specialsjump", wiifit_sideb_jump_smash_script)
    .game_acmd("game_specialairsjump", wiifit_sideb_jump_smash_script)
    .install();
