...
#[acmd_script( agent = "miienemyg", script = "game_attack12", category = ACMD_GAME )]
unsafe fn miienemyg_jab2_smash_script(fighter: &mut L2CAgentBase) {
...
#[acmd_script( agent = "miienemyg", script = "game_attack13", category = ACMD_GAME )]
unsafe fn miienemyg_jab3_smash_script(fighter: &mut L2CAgentBase) {
...
#[acmd_script( agent = "miienemyg", script = "game_attackdash", category = ACMD_GAME )]
unsafe fn miienemyg_dashattack_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 10.0);
    if macros::is_excute(fighter) {
...
#[acmd_script( agent = "miienemyg", script = "game_attacks3", category = ACMD_GAME )]
unsafe fn miienemyg_ftilt_smash_script(fighter: &mut L2CAgentBase) {
...
#[acmd_script( agent = "miienemyg", script = "game_attackhi3", category = ACMD_GAME )]
unsafe fn miienemyg_utilt_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 5.0);
    if macros::is_excute(fighter) {
...
#[acmd_script( agent = "miienemyg", script = "game_attacklw3", category = ACMD_GAME )]
unsafe fn miienemyg_dtilt_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 8.0);
    if macros::is_excute(fighter) {
...
#[acmd_script( agent = "miienemyg", script = "game_attacks4", category = ACMD_GAME )]
unsafe fn miienemyg_fsmash_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 6.0);
    if macros::is_excute(fighter) {
...
#[acmd_script( agent = "miienemyg", script = "game_attackhi4", category = ACMD_GAME )]
unsafe fn miienemyg_usmash_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 8.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
#[acmd_script( agent = "miienemyg", script = "game_attacklw4", category = ACMD_GAME )]
unsafe fn miienemyg_dsmash_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 6.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, *FIGHTER_STATUS_ATTACK_FLAG_START_SMASH_HOLD);
    }
...
#[acmd_script( agent = "miienemyg", script = "game_attackairn", category = ACMD_GAME )]
unsafe fn miienemyg_nair_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 4.0);
    if macros::is_excute(fighter) {
...
#[acmd_script( agent = "miienemyg", script = "game_attackairf", category = ACMD_GAME )]
unsafe fn miienemyg_fair_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 6.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor,  *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
    sv_animcmd::frame(fighter.lua_state_agent, 10.0);
    if macros::is_excute(fighter) {
        ArticleModule::generate_article(fighter.module_accessor, *FIGHTER_MIIENEMYG_GENERATE_ARTICLE_ATTACKAIRF_BULLET, false, 0);
    }
...
#[acmd_script( agent = "miienemyg_attackairf_bullet", script = "game_fly", category = ACMD_GAME )]
...
#[acmd_script( agent = "miienemyg", script = "game_attackairb", category = ACMD_GAME )]
unsafe fn miienemyg_bair_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 4.0);
    if macros::is_excute(fighter) {
        WorkModule::on_flag(fighter.module_accessor, *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
    }
...
#[acmd_script( agent = "miienemyg", script = "game_attackairhi", category = ACMD_GAME )]
unsafe fn miienemyg_uair_smash_script(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 6.0, 72, 110, 0, 50, 4.8, 0.0, 50.0, 0.0, Some(0.0), Some(12.0), Some(0.0), 1.0, 0.8, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_fire"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_ENERGY);
    }
    sv_animcmd::frame(fighter.lua_state_agent, 38.0);
    if macros::is_excute(fighter) {
        AttackModule::clear_all(fighter.module_accessor);
...
#[acmd_script( agent = "miienemyg", script = "game_attackairlw", category = ACMD_GAME )]
unsafe fn miienemyg_dair_smash_script(fighter: &mut L2CAgentBase) {
    sv_animcmd::frame(fighter.lua_state_agent, 1.0);
    if macros::is_excute(fighter) {
        MotionModule::set_rate(fighter.module_accessor, 2.0);
        WorkModule::on_flag(fighter.module_accessor, *FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING);
...
pub fn install() {
    ...
    smashline::install_acmd_scripts!(
        ...
        miienemyg_jab3_smash_script,
        miienemyg_dashattack_smash_script,
        miienemyg_ftilt_smash_script,
        miienemyg_utilt_smash_script,
        miienemyg_dtilt_smash_script,
        miienemyg_fsmash_smash_script,
        miienemyg_usmash_smash_script,
        miienemyg_dsmash_smash_script,
        miienemyg_nair_smash_script,
        miienemyg_fair_smash_script,
        fair_laser_projectile,
        miienemyg_bair_smash_script,
        miienemyg_uair_smash_script,
        miienemyg_dair_smash_script
